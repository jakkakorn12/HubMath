      ...
      <main className="max-w-6xl mx-auto px-4 py-8 space-y-5">
        <div className="bg-white rounded-card border-[0.5px] border-border p-5">
          <div className="flex items-center gap-2.5 mb-3">
            ...
            <h2 className="font-bold text-ink">สมัครสมาชิกครั้งแรก</h2>
          </div>
          <ol className="list-decimal list-inside space-y-1.5 text-sm text-ink-muted">
            <li>กด "สมัครสมาชิก" ที่หน้าเข้าสู่ระบบ</li>
            <li>กรอก <span className="font-medium text-ink">เลขประจำตัวนักเรียน</span> (5 หลัก เช่นที่ใช้ในโรงเรียน)</li>
            <li>กรอก <span className="font-medium text-ink">อีเมลจริงของตัวเอง</span> — ต้องเข้าถึงได้ ใช้กู้รหัสผ่าน</li>
        ...
        <div className="bg-white rounded-card border-[0.5px] border-border p-5">
          <div className="flex items-center gap-2.5 mb-3">
            <KeyRound className="w-5 h-5 text-ink-faint" />
            <h2 className="font-bold text-ink">ลืมรหัสผ่าน</h2>
          </div>
          <ol className="list-decimal list-inside space-y-1.5 text-sm text-ink-muted">
        ...
        <div className="bg-white rounded-card border-[0.5px] border-border p-5">
          <div className="flex items-center gap-2.5 mb-3">
            ...
            <h2 className="font-bold text-ink">ติดตั้งเป็นแอปบนมือถือ</h2>
          </div>
          <div className="space-y-2 text-sm text-ink-muted">
            <p><span className="font-medium text-ink">Android (Chrome):</span> เปิดเว็บ → กดเมนู ⋮ มุมขวาบน → "เพิ่มลงในหน้าจอหลัก"</p>
            <p><span className="font-medium text-ink">iPhone (Safari):</span> เปิดเว็บ → กดปุ่มแชร์ → "เพิ่มลงในหน้าจอโฮม"</p>
          </div>
        </div>

        <div className="bg-white rounded-card border-[0.5px] border-border p-5">
          <div className="flex items-center gap-2.5 mb-3">
            <MessageCircleQuestion className="w-5 h-5 text-ink-faint" />
            <h2 className="font-bold text-ink">ติดปัญหาอื่นๆ</h2>
          </div>
